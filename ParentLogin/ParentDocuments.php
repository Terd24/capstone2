...
// Fetch submitted documents for the child
...
<head>
  ...
  <title>Documents - CCI Parent Portal</title>
...
<header class="bg-[#0B2C62] text-white shadow-lg">
  ...
  <main class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">View your child's submitted documents history</p>
      </div>
    ...
    <div class="bg-white rounded-2xl card-shadow overflow-hidden">
      ...
      <?php else: ?>
        ...
        <div class="text-center py-16">
          ...
          <p class="text-gray-500 mb-8 max-w-md mx-auto">Your child hasn't submitted any documents yet.</p>
        </div>
      <?php endif; ?>
    </div>
