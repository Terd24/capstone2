...
// Check if student is logged in and needs to change password
if (!isset($_SESSION['student_id']) || !isset($_SESSION['must_change_password'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($new_password) || empty($confirm_password)) {
        ...
        $stmt = $conn->prepare("UPDATE student_account SET password = ?, must_change_password = 0 WHERE id = ?");
